...
Feature: Integer Vid subgraph
  ...
  Scenario: Integer Vid subgraph
    ...
    Then define some list variables:
      ...
      | [:like "Danny Green"->"Tim Duncan"@0]           | ("Shaquille O\'Neal")  | [:serve "Manu Ginobili"->"Spurs"@0]              |
      ...
      | [:like "Shaquille O\'Neal"->"Tim Duncan"@0]      | ("Marco Belinelli")   | [:like "Dejounte Murray"->"Tony Parker"@0]       |
  ...
  Scenario: Integer Vid two steps
    ...
    Then define some list variables:
      ...
      | [:like "Danny Green"->"Tim Duncan"@0]           | ("Shaquille O\'Neal")  | [:serve "Danny Green"->"Cavaliers"@0]            | ("Raptors")           | [:serve "Cory Joseph"->"Raptors"@0]           |
      ...
      | [:like "Shaquille O\'Neal"->"Tim Duncan"@0]      | ("Marco Belinelli")   | [:like "Tiago Splitter"->"Manu Ginobili"@0]      | ("Rudy Gay")          | [:serve "LeBron James"->"Lakers"@0]           |
      ...
      |                                                 |                       | [:like "Yao Ming"->"Shaquille O\'Neal"@0]         | ("Magic")             | [:serve "JaVale McGee"->"Lakers"@0]           |
      |                                                 |                       | [:like "Shaquille O\'Neal"->"JaVale McGee"@0]     | ("Trail Blazers")     | [:serve "Tracy McGrady"->"Magic"@0]           |
      |                                                 |                       | [:serve "Shaquille O\'Neal"->"Cavaliers"@0]       | ("76ers")             | [:serve "JaVale McGee"->"Warriors"@0]         |
      |                                                 |                       | [:serve "Shaquille O\'Neal"->"Celtics"@0]         | ("JaVale McGee")      |                                               |
      |                                                 |                       | [:serve "Shaquille O\'Neal"->"Heat"@0]            | ("Cory Joseph")       |                                               |
      |                                                 |                       | [:serve "Shaquille O\'Neal"->"Lakers"@0]          | ("Tracy McGrady")     |                                               |
      |                                                 |                       | [:serve "Shaquille O\'Neal"->"Magic"@0]           | ("Russell Westbrook") |                                               |
      |                                                 |                       | [:serve "Shaquille O\'Neal"->"Suns"@0]            | ("Bulls")             |                                               |
  ...
  Scenario: Integer Vid in and out edge
    ...
    Then define some list variables:
      ...
      | [:like "Shaquille O'Neal"->"Tim Duncan"@0]   | ("Shaquille O'Neal")   | [:like "Dejounte Murray"->"Danny Green"@0]      | ("Kings")          |                                              |
  ...
  Scenario: Integer Vid pipe
    ...
    Then define some list variables:
      ...
      | [:like "Danny Green"->"Tim Duncan"@0]           | ("Shaquille O\'Neal")  | [:teammate "Tony Parker"->"Manu Ginobili"@0]     |
      ...
      | [:like "Shaquille O\'Neal"->"Tim Duncan"@0]      | ("Marco Belinelli")   | [:teammate "Manu Ginobili"->"Tony Parker"@0]     |
  ...
  Scenario: Integer Vid many steps
    ...
    Then define some list variables:
      ...
      | [:serve "Yao Ming"->"Rockets"@0]        | ("Shaquille O'Neal") | [:serve "Shaquille O'Neal"->"Cavaliers"@0]   | ("Kobe Bryant")  | [:serve "Kobe Bryant"->"Lakers"@0]          | ("Manu Ginobili")     | [:serve "Manu Ginobili"->"Spurs"@0]              | ("Dirk Nowitzki")     | [:like "Dirk Nowitzki"->"Steve Nash"@0]       |
      | [:like "Yao Ming"->"Shaquille O'Neal"@0] | ("Tracy McGrady")   | [:serve "Shaquille O'Neal"->"Celtics"@0]     | ("Grant Hill")   | [:like "Paul Gasol"->"Kobe Bryant"@0]       | ("Paul Gasol")        | [:teammate "Tim Duncan"->"Manu Ginobili"@0]      | ("Kevin Durant")      | [:serve "Kevin Durant"->"Warriors"@0]         |
      | [:like "Yao Ming"->"Tracy McGrady"@0]   | ("Rockets")         | [:serve "Shaquille O'Neal"->"Heat"@0]        | ("Vince Carter") | [:serve "Grant Hill"->"Clippers"@0]         | ("Jason Kidd")        | [:teammate "Tony Parker"->"Manu Ginobili"@0]     | ("Damian Lillard")    | [:serve "Damian Lillard"->"Trail Blazers"@0]  |
      |                                         |                     | [:serve "Shaquille O'Neal"->"Lakers"@0]      | ("Tim Duncan")   | [:serve "Grant Hill"->"Magic"@0]            | ("Tony Parker")       | [:like "Dejounte Murray"->"Manu Ginobili"@0]     | ("James Harden")      | [:serve "James Harden"->"Rockets"@0]          |
      |                                         |                     | [:serve "Shaquille O'Neal"->"Magic"@0]       | ("JaVale McGee") | [:serve "Grant Hill"->"Pistons"@0]          | ("Marco Belinelli")   | [:like "Tiago Splitter"->"Manu Ginobili"@0]      | ("Chris Paul")        | [:like "Steve Nash"->"Dirk Nowitzki"@0]       |
      |                                         |                     | [:serve "Shaquille O'Neal"->"Suns"@0]        | ("Rudy Gay")     | [:serve "Grant Hill"->"Suns"@0]             | ("Dejounte Murray")   | [:like "Tony Parker"->"Manu Ginobili"@0]         | ("LeBron James")      | [:like "Russell Westbrook"->"James Harden"@0] |
      |                                         |                     | [:like "Shaquille O'Neal"->"JaVale McGee"@0] | ("Magic")        | [:serve "Vince Carter"->"Grizzlies"@0]      | ("Aron Baynes")       | [:serve "Paul Gasol"->"Bucks"@0]                 | ("Steve Nash")        | [:like "James Harden"->"Russell Westbrook"@0] |
      |                                         |                     | [:like "Shaquille O'Neal"->"Tim Duncan"@0]   | ("Spurs")        | [:serve "Vince Carter"->"Hawks"@0]          | ("Boris Diaw")        | [:serve "Paul Gasol"->"Bulls"@0]                 | ("Marc Gasol")        | [:serve "Chris Paul"->"Clippers"@0]           |
    ...
    Then define some list variables:
      ...
      | [:like "Boris Diaw"->"Tony Parker"@0]        | ("Marco Belinelli")   | [:like "Boris Diaw"->"Tim Duncan"@0]             | ("Shaquille O'Neal")   | [:serve "Rudy Gay"->"Kings"@0]                | ("JaVale McGee")    | [:serve "Ray Allen"->"Heat"@0]                | ("Vince Carter")       | [:serve "Kristaps Porzingis"->"Knicks"@0]    | ("Nets")       | [:like "Jason Kidd"->"Steve Nash"@0] |
      ...
      | [:like "Tony Parker"->"Manu Ginobili"@0]     |                       | [:like "Shaquille O'Neal"->"Tim Duncan"@0]        | ("LeBron James")      | [:serve "Kevin Durant"->"Warriors"@0]         | ("Cavaliers")       | [:serve "Paul George"->"Pacers"@0]            | ("Mavericks")          | [:like "Dirk Nowitzki"->"Steve Nash"@0]      |                | [:serve "Jason Kidd"->"Nets"@0]      |
      | [:like "Tony Parker"->"Tim Duncan"@0]        |                       | [:like "Tiago Splitter"->"Tim Duncan"@0]         | ("Chris Paul")        | [:serve "Shaquille O'Neal"->"Cavaliers"@0]     | ("Celtics")         | [:serve "Paul George"->"Thunders"@0]          | ("Nuggets")            | [:serve "Rajon Rondo"->"Bulls"@0]            |                | [:serve "Jason Kidd"->"Suns"@0]      |
      |                                              |                       | [:like "Tim Duncan"->"Manu Ginobili"@0]          | ("Bulls")             | [:serve "Shaquille O'Neal"->"Celtics"@0]       | ("Pistons")         | [:serve "JaVale McGee"->"Lakers"@0]           |                        | [:serve "Rajon Rondo"->"Celtics"@0]          |                | [:serve "Jason Kidd"->"Mavericks"@1] |
      |                                              |                       | [:serve "Boris Diaw"->"Hawks"@0]                 | ("Jazz")              | [:serve "Shaquille O'Neal"->"Heat"@0]          | ("Grizzlies")       | [:serve "JaVale McGee"->"Mavericks"@0]        |                        | [:serve "Rajon Rondo"->"Kings"@0]            |                | [:serve "Paul Gasol"->"Bucks"@0]     |
      |                                              |                       | [:serve "Boris Diaw"->"Hornets"@0]               | ("Hawks")             | [:serve "Shaquille O'Neal"->"Lakers"@0]        | ("Heat")            | [:serve "JaVale McGee"->"Nuggets"@0]          |                        | [:serve "Rajon Rondo"->"Lakers"@0]           |                | [:serve "Paul Gasol"->"Bulls"@0]     |
      |                                              |                       | [:serve "Boris Diaw"->"Jazz"@0]                  | ("Warriors")          | [:serve "Shaquille O'Neal"->"Magic"@0]         | ("Magic")           | [:serve "JaVale McGee"->"Warriors"@0]         |                        | [:serve "Rajon Rondo"->"Mavericks"@0]        |                | [:serve "Paul Gasol"->"Grizzlies"@0] |
      |                                              |                       | [:serve "Boris Diaw"->"Spurs"@0]                 | ("Suns")              | [:serve "Shaquille O'Neal"->"Suns"@0]          | ("Lakers")          | [:serve "JaVale McGee"->"Wizards"@0]          |                        | [:serve "Rajon Rondo"->"Pelicans"@0]         |                |                                      |
      |                                              |                       | [:serve "Boris Diaw"->"Suns"@0]                  | ("Trail Blazers")     | [:like "Yao Ming"->"Shaquille O'Neal"@0]       | ("Clippers")        | [:serve "Luka Doncic"->"Mavericks"@0]         |                        | [:serve "Vince Carter"->"Grizzlies"@0]       |                |                                      |
      |                                              |                       | [:serve "LaMarcus Aldridge"->"Spurs"@0]          | ("Kings")             | [:like "Shaquille O'Neal"->"JaVale McGee"@0]   | ("Thunders")        | [:like "Kristaps Porzingis"->"Luka Doncic"@0] |                        | [:serve "Vince Carter"->"Hawks"@0]           |                |                                      |
    ...
    Then define some list variables:
      ...
      | [:like "Shaquille O'Neal"->"Tim Duncan"@0]   | ("Tiago Splitter")    | [:like "Dejounte Murray"->"James Harden"@0]      | ("Russell Westbrook") | [:like "Chris Paul"->"Dwyane Wade"@0]         | ("Paul George")     | [:like "Luka Doncic"->"Dirk Nowitzki"@0]      |                        |
      | [:like "Tiago Splitter"->"Tim Duncan"@0]    | ("Shaquille O'Neal")   | [:like "Dejounte Murray"->"Kevin Durant"@0]      | ("Yao Ming")          | [:like "Chris Paul"->"LeBron James"@0]        |                     | [:like "Luka Doncic"->"Kristaps Porzingis"@0] |                        |
  ...
  Scenario: yield Integer Vid zero step
    When executing query:
      """
  ...
  Scenario: yield Integer Vid subgraph
    When executing query:
      """
      GET SUBGRAPH WITH PROP FROM hash('Tim Duncan') YIELD vertices as nodes, edges as relationships
      """
    Then define some list variables:
      | edge1                                           | vertex2               | edge2                                            |
      | [:teammate "Manu Ginobili"->"Tim Duncan"@0]     | ("Danny Green")       | [:teammate "Tony Parker"->"Manu Ginobili"@0]     |
  ...
  Scenario: yield Integer Vid two steps
    When executing query:
      """
      GET SUBGRAPH WITH PROP 2 STEPS FROM hash('Tim Duncan') YIELD vertices as nodes, edges as relationships
      """
    Then define some list variables:
      | edge1                                           | vertex2               | edge2                                            | vertex3               | edge3                                         |
      | [:teammate "Manu Ginobili"->"Tim Duncan"@0]     | ("Danny Green")       | [:like "Dejounte Murray"->"Danny Green"@0]       | ("Cavaliers")         | [:serve "LeBron James"->"Cavaliers"@0]        |
  ...
  Scenario: yield Integer Vid in edge
    When executing query:
      """
      GET SUBGRAPH WITH PROP 2 STEPS FROM hash('Tim Duncan') IN like, serve YIELD vertices as a, edges as b
      """
    Then define some list variables:
      | edge1                                       | vertex2               | edge2                                           | vertex3            |
      | [:like "Aron Baynes"->"Tim Duncan"@0]       | ("LaMarcus Aldridge") | [:like "Damian Lillard"->"LaMarcus Aldridge"@0] | ("Damian Lillard") |
  ...
  Scenario: yield Integer Vid in and out edge
    When executing query:
      """
      GET SUBGRAPH WITH PROP 2 STEPS FROM hash('Tim Duncan') IN like OUT serve YIELD vertices as a, edges as b
      """
    Then define some list variables:
      | edge1                                       | vertex2               | edge2                                           | vertex3            | edge3                                        |
      | [:serve "Tim Duncan"->"Spurs"@0]            | ("LaMarcus Aldridge") | [:serve "LaMarcus Aldridge"->"Spurs"@0]         | ("Damian Lillard") | [:serve "Damian Lillard"->"Trail Blazers"@0] |
  ...
  Scenario: yield Integer Vid two steps in and out edge
    When executing query:
      """
      GET SUBGRAPH WITH PROP 2 STEPS FROM hash('Tim Duncan'), hash('James Harden') IN teammate OUT serve YIELD VERTICES as a, EDGES as b
      """
    Then define some list variables:
      | vertex1          | edge1                                       | vertex2           | edge2                                        | vertex3     |
      | ("Tim Duncan")   | [:serve "Tim Duncan"->"Spurs"@0]            | ("Manu Ginobili") | [:serve "Manu Ginobili"->"Spurs"@0]          | ("Hornets") |
  ...
  Scenario: yield Integer Vid three steps
    When executing query:
      """
      GET SUBGRAPH WITH PROP 3 STEPS FROM hash('Paul George') OUT serve BOTH like YIELD vertices as A, EDGES as B
      """
    Then define some list variables:
      | edge1                                        | edge2                                            | edge3                                          | vertex4             | edge4                                      |
      | [:like "Russell Westbrook"->"Paul George"@0] | [:like "Dejounte Murray"->"Russell Westbrook"@0] | [:serve "Dejounte Murray"->"Spurs"@0]          | ("Kyle Anderson")   | [:like "Tony Parker"->"Tim Duncan"@0]      |
  ...
  Scenario: yield Integer Vid bidirect edge
    When executing query:
      """
      GET SUBGRAPH WITH PROP FROM hash('Tony Parker') BOTH like YIELD VERTICES as nodes , EDGES as relationships
      """
    Then define some list variables:
      | edge1                                        | vertex2               | edge2                                          |
      | [:like "Boris Diaw"->"Tony Parker"@0]        | ("Manu Ginobili")     | [:like "Manu Ginobili"->"Tim Duncan"@0]        |
  ...
  Scenario: yield Integer Vid pipe
    When executing query:
      """
      GO FROM hash('Tim Duncan') over serve YIELD serve._src AS id | GET SUBGRAPH WITH PROP FROM $-.id YIELD vertices as nodes, edges as relationships
      """
    Then define some list variables:
      | edge1                                           | vertex2               | edge2                                            |
      | [:teammate "Manu Ginobili"->"Tim Duncan"@0]     | ("Danny Green")       | [:like "Dejounte Murray"->"Danny Green"@0]       |
  ...
  Scenario: yield Integer Vid var
    When executing query:
      """
      $a = GO FROM hash('Tim Duncan') over serve YIELD serve._src AS id;
      GET SUBGRAPH WITH PROP FROM $a.id YIELD vertices as nodes, edges as relationships
      """
    Then define some list variables:
      | edge1                                           | vertex2               | edge2                                            |
      | [:teammate "Manu Ginobili"->"Tim Duncan"@0]     | ("Danny Green")       | [:like "Dejounte Murray"->"Danny Green"@0]       |
  ...
  Scenario: yield Integer Vid many steps
    When executing query:
      """
    ...
    When executing query:
      """
      GET SUBGRAPH WITH PROP 4 steps from hash('Yao Ming') IN teammate OUT serve BOTH like YIELD VERTiCeS as nodes , EDgES as relationships
      """
    Then define some list variables:
      | edge1                                   | vertex2             | edge2                                       | vertex3          | edge3                                       | vertex4               | edge4                                            | vertex5               | edge5                                         |
      | [:serve "Yao Ming"->"Rockets"@0]        | ("Shaquille O'Neal") | [:serve "Shaquille O'Neal"->"Cavaliers"@0]   | ("Kobe Bryant")  | [:serve "Kobe Bryant"->"Lakers"@0]          | ("Manu Ginobili")     | [:serve "Manu Ginobili"->"Spurs"@0]              | ("Dirk Nowitzki")     | [:like "Dirk Nowitzki"->"Steve Nash"@0]       |
    ...
    When executing query:
      """
      GET SUBGRAPH WITH PROP 5 steps from hash('Tony Parker') IN teammate OUT serve BOTH like YIELD VERTICES as a, EDGES as b
      """
    Then define some list variables:
      | edge1                                        | vertex2               | edge2                                            | vertex3               | edge3                                         | vertex4             | edge4                                         | vertex5                | edge5                                        | vertex6        | edge6                                |
      | [:serve "Tony Parker"->"Hornets"@0]          | ("Tim Duncan")        | [:serve "Tim Duncan"->"Spurs"@0]                 | ("Aron Baynes")       | [:serve "Aron Baynes"->"Celtics"@0]           | ("Yao Ming")        | [:serve "Yao Ming"->"Rockets"@0]              | ("Grant Hill")         | [:serve "Grant Hill"->"Clippers"@0]          | ("Steve Nash") | [:serve "Steve Nash"->"Lakers"@0]    |
    ...
    When executing query:
      """
      GET SUBGRAPH WITH PROP 4 steps from hash('Tim Duncan') BOTH like YIELD vertices as nodes, edges as relationships
      """
    Then define some list variables:
      | edge1                                       | vertex2               | edge2                                            | vertex3               | edge3                                         | vertex4             | edge4                                         | vertex5                |
      | [:like "Aron Baynes"->"Tim Duncan"@0]       | ("LaMarcus Aldridge") | [:like "Damian Lillard"->"LaMarcus Aldridge"@0]  | ("Kevin Durant")      | [:like "Luka Doncic"->"James Harden"@0]       | ("Tracy McGrady")   | [:like "Grant Hill"->"Tracy McGrady"@0]       | ("Kobe Bryant")        |
  ...
  Scenario: yield Integer Vid over end
    When executing query:
      """
  ...
  Scenario: yield Integer Vid many steps without prop
    When executing query:
      """
    ...
    When executing query:
      """
      GET SUBGRAPH 4 steps from hash('Yao Ming') IN teammate OUT serve BOTH like YIELD VERTICES as nodes, EDGES as relationships
      """
    Then define some list variables:
      | edge1                                   | vertex2             | edge2                                       | vertex3          | edge3                                       | vertex4               | edge4                                            | vertex5               | edge5                                         |
      | [:serve "Yao Ming"->"Rockets"@0]        | ("Shaquille O'Neal") | [:serve "Shaquille O'Neal"->"Cavaliers"@0]   | ("Kobe Bryant")  | [:serve "Kobe Bryant"->"Lakers"@0]          | ("Manu Ginobili")     | [:serve "Manu Ginobili"->"Spurs"@0]              | ("Dirk Nowitzki")     | [:like "Dirk Nowitzki"->"Steve Nash"@0]       |
    ...
    When executing query:
      """
      GET SUBGRAPH 5 steps from hash('Tony Parker') IN teammate OUT serve BOTH like YIELD VERTICES as nodes, EDGES as relationships
      """
    Then define some list variables:
      | edge1                                        | vertex2               | edge2                                            | vertex3               | edge3                                         | vertex4             | edge4                                         | vertex5                | edge5                                        | vertex6        | edge6                                |
      | [:serve "Tony Parker"->"Hornets"@0]          | ("Tim Duncan")        | [:serve "Tim Duncan"->"Spurs"@0]                 | ("Aron Baynes")       | [:serve "Aron Baynes"->"Celtics"@0]           | ("Yao Ming")        | [:serve "Yao Ming"->"Rockets"@0]              | ("Grant Hill")         | [:serve "Grant Hill"->"Clippers"@0]          | ("Steve Nash") | [:serve "Steve Nash"->"Lakers"@0]    |
    ...
    When executing query:
      """
      GET SUBGRAPH 4 steps from hash('Tim Duncan') BOTH like YIELD VERTICES as nodes, EDGES as relationships
      """
    Then define some list variables:
      | edge1                                       | vertex2               | edge2                                            | vertex3               | edge3                                         | vertex4             | edge4                                         | vertex5                |
      | [:like "Aron Baynes"->"Tim Duncan"@0]       | ("LaMarcus Aldridge") | [:like "Damian Lillard"->"LaMarcus Aldridge"@0]  | ("Kevin Durant")      | [:like "Luka Doncic"->"James Harden"@0]       | ("Tracy McGrady")   | [:like "Grant Hill"->"Tracy McGrady"@0]       | ("Kobe Bryant")        |
  ...
  Scenario: subgraph yield vertex edge
    When executing query:
      """
      GET SUBGRAPH WITH PROP 2 STEPS FROM hash('Tim Duncan'), hash('James Harden') IN teammate OUT serve YIELD VERTICES as nodes
      """
    Then define some list variables:
      | vertex1          | vertex2           |
      | ("Tim Duncan")   | ("Manu Ginobili") |
      | ("James Harden") | ("Tony Parker")   |
      |                  | ("Spurs")         |
      |                  | ("Rockets")       |
      |                  | ("Thunders")      |
      |                  |                   |
    ...
    When executing query:
      """
      GET SUBGRAPH WITH PROP 2 STEPS FROM hash('Tim Duncan') IN like, serve YIELD EDGES as relationships
      """
    Then define some list variables:
      | edge1                                       | edge2                                           |
      | [:like "Aron Baynes"->"Tim Duncan"@0]       | [:like "Damian Lillard"->"LaMarcus Aldridge"@0] |
      | [:like "Boris Diaw"->"Tim Duncan"@0]        | [:like "Rudy Gay"->"LaMarcus Aldridge"@0]       |
      | [:like "Danny Green"->"Tim Duncan"@0]       | [:like "Tony Parker"->"LaMarcus Aldridge"@0]    |
      | [:like "Dejounte Murray"->"Tim Duncan"@0]   | [:like "Dejounte Murray"->"Danny Green"@0]      |
      | [:like "LaMarcus Aldridge"->"Tim Duncan"@0] | [:like "Marco Belinelli"->"Danny Green"@0]      |
      | [:like "Manu Ginobili"->"Tim Duncan"@0]     | [:like "Danny Green"->"Marco Belinelli"@0]      |
      | [:like "Marco Belinelli"->"Tim Duncan"@0]   | [:like "Dejounte Murray"->"Marco Belinelli"@0]  |
      | [:like "Shaquille O'Neal"->"Tim Duncan"@0]   | [:like "Dejounte Murray"->"Manu Ginobili"@0]    |
      | [:like "Tiago Splitter"->"Tim Duncan"@0]    | [:like "Tiago Splitter"->"Manu Ginobili"@0]     |
      | [:like "Tony Parker"->"Tim Duncan"@0]       | [:like "Tim Duncan"->"Manu Ginobili"@0]         |
      |                                             | [:like "Tony Parker"->"Manu Ginobili"@0]        |
      |                                             | [:like "Yao Ming"->"Shaquille O'Neal"@0]         |
      |                                             | [:like "Boris Diaw"->"Tony Parker"@0]           |
      |                                             | [:like "Dejounte Murray"->"Tony Parker"@0]      |
